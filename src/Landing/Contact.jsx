...
export default function Contact() {
    return (
        <section >
            <p className="contact-section-tag">Contact</p>
            <div className="contact">
                <div className="contact-left">
                    <h2 className="contact-heading">
                        ...
                        Any Question or
                        <br />
                        <span className="contact-orange">Custom Order?</span>
                    </h2>
                </div>
                ...
                <div className="contact-right">
                    ...
                    <div className="contact-block">
                        ...
                        {/* <p className="contact-block-text">
                            7694 Islington Ave, Woodbridge, Ontario L4L 1W3, Canada
                        </p> */}
                        <a
                    ...
                    <div className="contact-row">
                        <div className="contact-block">
                            ...
                            <a href="tel:+19052660331" className="contact-block-text">+1 905-266-0331</a>
                            <a href="mailto:info@whot.ca" className="contact-block-text">info@whot.ca</a>
                        </div>
                        ...
                        <div className="contact-block">
                            ...
                            <div className="contact-socials">
                                {/* Instagram Icon */}
                                <a href="https://www.instagram.com/whotrestaurantlounge/?hl=en" target="_blank" rel="noopener noreferrer" className="social-link">
                                ...
                                {/* TikTok Icon */}
                                <a href="https://vm.tiktok.com/ZS91A2HPuhGH9-2DGBC/" target="_blank" rel="noopener noreferrer" className="social-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 256 290">
