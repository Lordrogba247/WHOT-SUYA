...
//             {/* Tag sits outside left/right so it can be ordered first on mobile */}
...
//                     Do You Have<br />
//                     Any Question or<br />
//                     <span className="contact-red">Custom Order?</span>
//                 </h2>
//             </div>

//             <div className="contact-right">
//                 <div className="contact-block">
//                     <p className="contact-block-title">Address</p>
//                     <a
//                         href="https://www.google.com/maps/search/?api=1&query=7694+Islington+Ave+Woodbridge+Ontario+L4L+1W3+Canada"
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="contact-block-text"
//                     >
//                         7694 Islington Ave,
...
//                     <div className="contact-block">
//                         <p className="contact-block-title">Contacts</p>
//                         <a href="tel:+19052660331" className="contact-link">+1 905-266-0331</a>
//                         <a href="mailto:whotfoodsinc@gmail.com" className="contact-link">whotfoodsinc@gmail.com</a>
//                     </div>
